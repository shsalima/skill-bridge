...
import { authentificationCheck, checkAdminLimit } from "../middleware/authentication.middleware.js"
import { preventRoleUpdate } from "../middleware/preventRoleUpdate.middleware.js"

const router= express.Router()

router.post("/register",registerValidator,validate,checkAdminLimit,register)
